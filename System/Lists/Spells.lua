    ...
    DRUID = {
        ...
        Shared = {
            abilities                       = {
                ...
                cyclone                     = 33786,
                dash                        = 33357,
                demoralizingRoar            = 48560,
                direBearForm                = 9634,
                enrage                      = 5229,
                entanglingRoots             = 53308,
                fairieFire                  = 770,
    ...
    WARRIOR = {
        ...
        [71] = {
            ...
            artifacts                       = {
                ...
                deathblow                   = 209481,
                defensiveMeasures           = 209559,
                executionersPrecision       = 238147,
                exploitTheWeakness          = 209494,
                focusInBattle               = 209554,
                manyWillFall                = 216274,
                oneAgainstMany              = 209462,
                preciseStrikes              = 209492,
                shatteredDefenses           = 209574,
                tacticalAdvance             = 209483,
                thoradinsMight              = 209480,
                touchOfZakajz               = 209541,
                unbreakableSteel            = 214937,
                unendingRage                = 209459,
                voidCleave                  = 209573,
                warbreaker                  = 209577,
                willOfTheFirstKing          = 209548,
            },
            buffs                           = {
                cleave                      = 188923,
            ...
            talents                         = {
                ...
                inForTheKill                = 215550,
                mortalCombo                 = 202593,
                opportunityStrikes          = 203179,
                overpower                   = 7384,
                ravager                     = 152277,
                rend                        = 772,
                secondWind                  = 29838,
                sweepingStrikes             = 202161,
                titanicMight                = 202612,
                trauma                      = 215538,
            },
        },
