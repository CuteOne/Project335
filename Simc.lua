...
local function parse_expression(name_str)
    ...
    if data_type then
        ...
        -- print(tostring(data_type).." | "..tostring(data_identifier).." | "..tostring(data_arg))
        if data_type == "race" then
        ...
        elseif data_type == "action" and data_arg == "in_flight" then
            return "cast.last." .. action .. "()"
        --Resources
    elseif data_type == "focus" or data_type == "fury" or data_type == "holy_power" then
