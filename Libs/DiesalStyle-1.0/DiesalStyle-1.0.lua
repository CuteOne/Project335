...
local function setColor(texture, r, g, b, a)
  local status, err = pcall( texture.SetTexture, texture, r, g, b, a )
...
function DiesalStyle:StyleTexture(texture,style)
  ...
  if texture.style.image then -- [1] Texture
    ...
    texture:SetTexture(1,1,1,1) -- clear color
    -- apply settings
  ...
  elseif texture.style.color then -- [3] color
    ...
    texture:SetTexture(0,0,0,0) -- clear color
  end
end
...
function DiesalStyle:StyleOutline(leftTexture,rightTexture,topTexture,bottomTexture,style)
  ...
  if texture.style.gradient then
    ...
    if texture.style.gradient.orientation == 'HORIZONTAL' then
      ...
      topTexture:SetTexture(1,1,1,1) -- clear color
      bottomTexture:SetTexture(1,1,1,1) -- clear color
    ...
    elseif texture.style.gradient.orientation == 'VERTICAL' then
      -- clear settings
      leftTexture:SetTexture(1,1,1,1) -- clear color
      rightTexture:SetTexture(1,1,1,1) -- clear color
...
--     -- [3] color
--     texture:SetTexture(texture.style.red,texture.style.green,texture.style.blue,texture.style.alpha or 1)
--   end
-- end
